...
def _write_baseline(chunks: dict[str, str]) -> None:
    header = [
        ...
        "# A chunk id already hashes doc, page, element ids and body text, so a",
        "# changed body shows up as a removal plus an addition. The digest covers",
        "# what the id does not: the context-header breadcrumb prepended to the",
        "# stored text.",
        "#",
